...
function display(indexOfWebsite) {
  ...
  var newBookmark = `
              <tr>
                ...
                <td>
                  <button class="btn btn-warning btn-visit" data-index="${indexOfWebsite}">
                    <i class="fa-solid fa-eye pe-2"></i>Visit
                  </button>
                </td>
                <td>
                  <button class="btn btn-danger btn-delete pe-2" data-index="${indexOfWebsite}">
